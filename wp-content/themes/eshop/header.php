								...
								<ul class="header-cart-wrapitem">
									<li class="header-cart-item">
										<div class="header-cart-item-img">
											<img src="<?php echo get_template_directory_uri(); ?>/images/item-cart-01.jpg" alt="IMG">
										</div>
									...
									<li class="header-cart-item">
										<div class="header-cart-item-img">
											<img src="<?php echo get_template_directory_uri(); ?>/images/item-cart-02.jpg" alt="IMG">
										</div>
										<div class="header-cart-item-txt">
											<a href="#" class="header-cart-item-name">
									...
									<li class="header-cart-item">
										<div class="header-cart-item-img">
											<img src="<?php echo get_template_directory_uri(); ?>/images/item-cart-03.jpg" alt="IMG">
										</div>
										<div class="header-cart-item-txt">
											<a href="#" class="header-cart-item-name">
