					...
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="<?php echo get_template_directory_uri(); ?>/images/blog-04.jpg" alt="IMG-BLOG">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="<?php echo get_template_directory_uri(); ?>/images/blog-05.jpg" alt="IMG-BLOG">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.html" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="<?php echo get_template_directory_uri(); ?>/images/blog-08.jpg" alt="IMG-BLOG">
				...
				<div class="col-md-4 col-lg-3 p-b-75">
					<div class="rightbar">
						...
						<ul class="bgwhite">
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="<?php echo get_template_directory_uri(); ?>/images/item-17.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.html" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="<?php echo get_template_directory_uri(); ?>/images/item-08.jpg" alt="IMG-PRODUCT">
								</a>
