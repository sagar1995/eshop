			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="<?php echo get_template_directory_uri(); ?>/images/banner-02.jpg" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="<?php echo get_template_directory_uri(); ?>/images/banner-05.jpg" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="<?php echo get_template_directory_uri(); ?>/images/banner-03.jpg" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="<?php echo get_template_directory_uri(); ?>/images/banner-07.jpg" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="<?php echo get_template_directory_uri(); ?>/images/banner-04.jpg" alt="IMG-BENNER">
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
					<div class="hov-img-zoom pos-relative">
						<img src="<?php echo get_template_directory_uri(); ?>/images/banner-08.jpg" alt="IMG-BANNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
					<div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
						<img src="<?php echo get_template_directory_uri(); ?>/images/shop-item-09.jpg" alt="IMG-BANNER">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						<a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
							<img src="<?php echo get_template_directory_uri(); ?>/images/blog-01.jpg" alt="IMG-BLOG">
						</a>
						...
						<div class="block3-txt p-t-14">
							...
							<span class="s-text6">By</span> <span class="s-text7">Albert</span>
				...
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						<a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
							<img src="<?php echo get_template_directory_uri(); ?>/images/blog-02.jpg" alt="IMG-BLOG">
						</a>
						...
						<div class="block3-txt p-t-14">
							...
							<span class="s-text6">By</span> <span class="s-text7">Bijen</span>
							<span class="s-text6">on</span> <span class="s-text7">July 30, 2019</span>
				...
				<div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
					...
					<div class="block3">
						<a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
							<img src="<?php echo get_template_directory_uri(); ?>/images/blog-03.jpg" alt="IMG-BLOG">
						</a>

						<div class="block3-txt p-t-14">
							<h4 class="p-b-7">
								<a href="blog-detail.html" class="m-text11">
									Dhobighat Lalitpur: Rikesh Bajracharya 
								</a>
							</h4>

							<span class="s-text6">By</span> <span class="s-text7">Rikesh</span>
