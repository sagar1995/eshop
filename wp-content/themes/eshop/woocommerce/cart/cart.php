								...
								<td colspan="6" class="actions">
									<div class="flex-w flex-sb-m p-t-25 p-b-25 bo8 p-l-35 p-r-60 p-lr-15-sm">
										<div class="flex-w flex-m w-full-sm">
											...
											<div class="coupon size11 bo4 m-r-10">
												<input type="text" name="coupon_code" class="input-text sizefull s-text7 p-l-22 p-r-22" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" />
											</div>
											<div class="size12 trans-0-4 m-t-10 m-b-10 m-r-10">
												<button type="submit" class="button flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?></button>
												<?php do_action( 'woocommerce_cart_coupon' ); ?>
											</div>
										</div>
										<?php } ?>
										<div class="size10 trans-0-4 m-t-10 m-b-10">
											<button type="submit" id="update-cart-btn" class="button flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
										</div>
