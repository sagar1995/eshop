...
define( 'TULSI_VERSION', '1.0.0' );

if ( ! function_exists( 'tulsi_setup' ) ) {
	add_action( 'after_setup_theme', 'tulsi_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function tulsi_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'tulsi' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'tulsi' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in tulsi_smart_content_width()
		 */
...
define('TULSI_THEME_URL','https://wpkoi.com/tulsi-wpkoi-wordpress-theme/','tulsi');
define('TULSI_WPKOI_AUTHOR_URL','https://wpkoi.com/','tulsi');
define('TULSI_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','tulsi');
define('TULSI_WORDPRESS_REVIEW','https://wordpress.org/support/theme/tulsi/reviews/?filter=5','tulsi');
define('TULSI_DOCUMENTATION','https://wpkoi.com/docs/','tulsi');