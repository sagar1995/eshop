...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <textarea id="comment" name="comment" placeholder="Comment.." required="required" class="dis-block s-text7 size18 bo12 p-l-18 p-r-18 p-t-13 m-b-20"></textarea></p>',
		...
		/** This filter is documented in wp-includes/link-template.php */
		'logged_in_as'         => '<p class="logged-in-as s-text8 p-b-40">' . sprintf(
		...
		'title_reply_before'   => '<h3 id="reply-title" class="comment-reply-title m-text25 p-b-14">',
		'title_reply_after'    => '</h3>',
		'cancel_reply_before'  => ' <small>',
		'cancel_reply_after'   => '</small>',
		'cancel_reply_link'    => __( 'Cancel reply' ),
		'label_submit'         => __( 'Post Comment' ),
		'submit_button'        => '<input name="%1$s" type="submit" id="%2$s" class="%3$s flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4" value="%4$s" />',
		'submit_field'         => '<div class="w-size24">%1$s %2$s</div>',
		'format'               => 'xhtml',
	);
